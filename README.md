...
Suppose that Dik denotes the subset of the sample of category k in subset Di.  
    ...
    2. **compute H(D|A) of dataset given condition A D**  
...
Model Output: ID3 decision tree.  
  ...
  **Recurrent Pseudocode**:  
  ...
  (2.2.1) If ga > threshold e, then we split on feature a, and break dataset into separate subset Di. For each subset dataset in {D1, D2, ... Di}, treat Di as the new dataset D, treat A-{a} as the new feature set A, recurrently continue this splitting process.  
